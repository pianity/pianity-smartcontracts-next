...
impl AsyncActionable for Transfer {
    async fn action(self, _caller: String, mut state: State) -> ActionResult {
        log(&format!("Transfer: {}", Vrf::value()));

        // let transfer_amount = Vrf::randomInt(2) as u32;
        //
        // let transfer = Erc1155Action::Action::Transfer(Erc1155Action::Transfer {
        //     from: None,
        //     to: self.to.clone(),
        //     token_id: self.token_id.clone(),
        //     qty: Balance::new(transfer_amount),
        // });
        //
        // let result = write_foreign_contract::<
        //     InternalWriteResult,
        //     Erc1155ContractError,
        //     Erc1155Action::Action,
        // >(&state.settings.erc1155, transfer)
        // .await;
